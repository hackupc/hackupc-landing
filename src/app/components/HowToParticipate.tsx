      ...
      <Section id="howtoparticipate">
        ...
        <GridContainer>
          <PennantWrapper>
            ...
            <CardContent>
              <RoleTitle className={montserrat.className}>
                Mentor
              </RoleTitle>
              <Text className={montserrat.className}>
                Help and motivate hackers with your knowledge! If you 
                are passionate about helping, and you can no longer 
                apply as a hacker, we invite you to live the hackathon 
                experience from the other side: Apply as a mentor!
              </Text>
              <ApplyButton
          ...
          <PennantWrapper>
            ...
            <CardContent>
              ...
              <Text className={montserrat.className}>
                Volunteers make HackUPC possible by assisting the hackers 
                and preparing the event. By joining our team of volunteers, 
                you will get to know how this incredible event works from 
                the inside, meet amazing people and live a great experience!
              </Text>
              <ApplyButton
                className={montserrat.className}
          ...
          <PennantWrapper>
            ...
            <CardContent>
              ...
              <Text className={montserrat.className}>
                ...
                talents. Join us and be remembered as part of this 
