...
export const hackupc_faqs: FAQs[] = [
  ...
  },
  {
    ...
    answer: [
      {
        type: "Text",
        answer: "HackUPC will take place in ",
      },
      {
        type: "Link",
        answer: "UPC’s North Campus",
  ...
  },
  {
    ...
    answer: [
      {
        type: "List",
        answer: "All attendees must bring the following:",
        options: [
      ...
      {
        type: "List",
        answer: "Other common checklist items include:",
        options: [
          "Sleeping bag",
          "Comfortable clothes",
...
export const applications_faqs: FAQs[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      {
        type: "Link",
        answer: "On our Medium page, you can find a great post ",
