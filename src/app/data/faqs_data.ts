...
export const hackupc_faqs: FAQs[] = [
  ...
  },
  {
    ...
    answer:
      "HackUPC will take place in UPC’s North Campus FIB buildings (A3, A4, A5 and A6) in sunny Barcelona. Expect around 25ºC!",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "All attendees must bring the following: Valid government ID for admission and Laptop & charger (Be aware that Spain has Type F plugs, bring an adapter!). Other common checklist items include: Sleeping bag, Towel, flip-flops, and soap, we encourage all the hackers to take a shower! We will send you a more detailed checklist once you’re accepted.",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer:
      "Yes, here it is: Code of conduct. TL;DR: Be respectful, harassment and abuse are never tolerated.",
  },
];
